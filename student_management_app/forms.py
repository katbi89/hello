...
class AddStudentForm(forms.Form):
    email = forms.EmailField(label="البريد الإلكتروني", max_length=50, widget=forms.EmailInput(attrs={"class":"form-control"}))
    ...
    gender = forms.ChoiceField(label="الجنس", choices=gender_list, widget=forms.Select(attrs={"class":"form-control"}))
    session_year_id = forms.ChoiceField(label="الجلسة", choices=session_year_list, widget=forms.Select(attrs={"class":"form-control"}))
    # session_start_year = forms.DateField(label="Session Start", widget=DateInput(attrs={"class":"form-control"}))
    # session_end_year = forms.DateField(label="Session End", widget=DateInput(attrs={"class":"form-control"}))
    profile_pic = forms.FileField(label="الصورة الشخصية", required=False, widget=forms.FileInput(attrs={"class":"form-control"}))
